...
********* Building Project Analysis for data set 2 *********
...
save "$path/residential building DataSet2.dta",replace

********** control group  ********** 
drop if randomR == 2 
save "$path/residential building DataSet2 control.dta",replace
import excel "$path/dataset2 resid control.xlsx",clear
save "$path/dataset2 resid control.dta", replace 
merge 1:1 _n using "$path/residential building DataSet2 control.dta"
...
********** treatment group  ********** 
use "$path/residential building DataSet2.dta",clear
drop if randomR == 1
save "$path/residential building DataSet2 treatment.dta",replace
import excel "$path/dataset2 resid treatment.xlsx",clear
save "$path/dataset2 resid treatment.dta", replace 
merge 1:1 _n using "$path/residential building DataSet2 treatment.dta"
...
save "$path/public building DataSet2.dta",replace

********** control group  ********** 
drop if randomR == 2 

save "$path/public building DataSet2 control.dta",replace
import excel "$path/dataset2 public control.xlsx",clear
save "$path/dataset2 public control.dta", replace 
merge 1:1 _n using "$path/public building DataSet2 control.dta"
...
********** treatment group  ********** 
use "$path/public building DataSet2.dta",clear
drop if randomR == 1
save "$path/public building DataSet2 treatment.dta",replace
import excel "$path/dataset2 public treatment.xlsx",clear
save "$path/dataset2 public treatment.dta", replace 
merge 1:1 _n using "$path/public building DataSet2 treatment.dta"
...
save "$path/office building DataSet2.dta",replace

********** control group  ********** 
drop if randomR == 2 
save "$path/office building DataSet2 control.dta",replace
import excel "$path/dataset2 office control.xlsx",clear
save "$path/dataset2 office control.dta", replace 
merge 1:1 _n using "$path/office building DataSet2 control.dta"
...
********** treatment group  ********** 
use "$path/office building DataSet2.dta",clear
drop if randomR == 1
save "$path/office building DataSet2 treatment.dta",replace
import excel "$path/dataset2 office treatment.xlsx",clear
save "$path/dataset2 office treatment.dta", replace 
merge 1:1 _n using "$path/office building DataSet2 treatment.dta"
